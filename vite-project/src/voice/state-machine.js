(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["StateMachine"] = factory();
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        mixin(Config.prototype, {
          ...
          addTransitionLifecycleNames: function (name) {
            this.lifecycle.onBefore[name] = camelize.prepended(
              "onBefore",
              name
            );
          ...
          configureInitTransition: function (init) {
            if (typeof init === "string") {
              return this.mapTransition(
                mixin({}, this.defaults.init, { to: init, active: true })
              );
            } else if (typeof init === "object") {
              return this.mapTransition(
                mixin({}, this.defaults.init, init, { active: true })
              );
            } else {
          ...
          configureTransitions: function (transitions) {
            ...
            for (n = 0; n < transitions.length; n++) {
              ...
              from = Array.isArray(transition.from)
                ? transition.from
          ...
          transitionFor: function (state, transition) {
            ...
            return (
              this.map[state][transition] || this.map[wildcard][transition]
            );
          },

          transitionsFor: function (state) {
            var wildcard = this.defaults.wildcard;
            return Object.keys(this.map[state]).concat(
              Object.keys(this.map[wildcard])
            );
          },
        ...
        mixin(JSM.prototype, {
          ...
          transit: function (transition, from, to, args) {
            var lifecycle = this.config.lifecycle,
              changed =
                this.config.options.observeUnchangedState || from !== to;
